...
```{r, cache = T}
traincsv <- read.csv("C:/Users/Darth Saxena/Desktop/Practical ML Week 4 PGA/pml-training.csv")
testcsv <- read.csv("C:/Users/Darth Saxena/Desktop/Practical ML Week 4 PGA/pml-testing.csv")
dim(traincsv)
dim(testcsv)
```
